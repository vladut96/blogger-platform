...
let SecurityDevicesService = class SecurityDevicesService {
    ...
    async deleteAllExceptCurrent(userId, currentDeviceId) {
        await this.securityDevicesRepository.deleteAllExceptCurrent(userId, currentDeviceId);
    }
};
...
exports.SecurityDevicesService = SecurityDevicesService = __decorate([
    ...
    __metadata("design:paramtypes", [security_devices_repository_1.SecurityDevicesRepository])
